<template>
<footer class="font-sans tracking-wide bg-gray-500 py-10 px-12">
      ...
      <p class='text-gray-300 text-right text-[15px] mt-8'>© 2023<a href='https://readymadeui.com/' target='_blank'
